# Retrieval eval rag-v1-heading-prefix-dev

- variant: `heading-prefix` split: `dev` top_k: 5 probe_k: 20
...
|---|---|---|---|
| answerable | full Evidence Recall@5 | 9/18 | 0.5 |
| answerable | Evidence Hit@3 | 8/18 | 0.4444 |
| answerable | mean Evidence Recall@5 | - | 0.5 |
| answerable | MRR@5 | - | 0.3352 |
...
|---|---|---|---|---|---|
| fact | 4/7 | 4/7 | 0.5714 | 0.5 | 0.7143 |
...
- min: 77.46 ms, p50: 173.03 ms, p95: 231.47 ms
- index build: 7758 ms
...
- chunks: 176 (p50 142, max 474, mean 169.8)
- 超限（被模型静默截断）的块数: **31** ['OWL2_Document_Overview', 'Python_Tutorial_Interpreter', 'Python_Tutorial_Overview', 'Writing_Effective_Tools_for_Agents']
...
| q21 | mixed_language | 0.0 | 0.0 | False | evidence_not_in_returned_fragments | BinaryTree.md, 1.0754 |
