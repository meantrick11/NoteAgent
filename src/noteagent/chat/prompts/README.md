...
| [`iterations/`](iterations/README.md) | 历次全文归档；现为 v1–v9。v9 与现行 `system.txt` 字节一致 |
...
2026-09-10 同模型 Judge 实跑（[`v9-learning_l01_20260910-215727`](../../../../evals/prompt/results/learning_notes/v9-learning_l01_20260910-215727/)）：硬门与复习题通过，结构 2/4、加工 1/4，不合格。现行 `system.txt` 仍是 v9，下一步应只改生成提示词，不要同时改 Judge。
