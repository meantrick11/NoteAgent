...
| V1.4 | 实现中，待补验收证据 | **RAG 查询集缺口已闭合**：40 条带证据标注的查询（dev 24 / holdout 16）+ 20 条 Agent 场景、可重复的评测入口与真实基线（[rag-v1-report.md](../evaluations/rag-v1-report.md)）；仍缺：生成样例 ≥20 条的汇总、端到端闭环演示 |
