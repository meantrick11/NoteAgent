...
子系统设计说明的索引。现行全局架构在 [../architecture/architecture.md](../architecture/architecture.md)。
...
| [../architecture/retrieval.md](../architecture/retrieval.md) | 切块与 Chroma |
| [../plans/draft-generation.md](../plans/draft-generation.md) | 入库 Job 设想（非现行） |
